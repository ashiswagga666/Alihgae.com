...
<div class="mt-5 flex items-center gap-3">
    <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 transition"><i class="fas fa-save mr-2"></i>Simpan Perubahan</button>
    ...
    <label class="flex items-center gap-2 ml-auto">
        <input type="checkbox" name="is_active" value="1" {{ isset($lowongan) && $lowongan->is_active ? 'checked' : '' }} class="w-4 h-4 accent-blue-600">
